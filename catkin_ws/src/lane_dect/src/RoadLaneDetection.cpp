...
int height = 720;
    ...
    src_vertices[1] = Point(width * 0.80, height);  // Bottom-right
    src_vertices[2] = Point(width * 0.72, height * 0.80);  // Top-right
    src_vertices[3] = Point(width * 0.30, height * 0.80);  // Top-left
